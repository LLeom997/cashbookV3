          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-3">
              ...
              {joinCodes.length === 0 ? (
                ...
                <div className="space-y-2">
                  {joinCodes.map(code => (
                    <div key={code.id} className="flex items-center justify-between p-3 bg-blue-50 border border-blue-100 rounded-xl shadow-sm">
                      <div className="flex items-center gap-3">
              ...
              {collaborators.length === 0 ? (
                ...
                <div className="space-y-2">
                  {collaborators.map(collab => (
                    <div key={collab.id} className="flex items-center justify-between p-3 bg-white border border-slate-100 rounded-xl shadow-sm">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 font-bold">
                          {collab.userEmail[0].toUpperCase()}
                        </div>
                        <div>
                          <p className="text-sm font-bold text-slate-800">{collab.userEmail}</p>
